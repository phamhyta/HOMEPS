    ...
    <div class="row w-100">
        <div class="col-lg-12 col-md-12 col-12">
            ...
            <p class="mb-5 text-center">
                <i class="text-info font-weight-bold">{{ $quantity }}</i> items in your cart</p>
            <table id="shoppingCart" class="table table-condensed table-responsive">
                ...
                @endif
                    ...
                    <tr>
                        <td data-th="Product">
                            <div class="row">
                                <div class="col-md-3 text-left">
                                    <img src="{{ $c['photo'] }}" alt="" class="img-fluid d-none d-md-block rounded mb-2 shadow ">
                                </div>
                        ...
                        <td data-th="Quantity">
                            <input type="number" class="form-control form-control-lg text-center" value="{{ $c['quantity'] }}">
                        </td>
